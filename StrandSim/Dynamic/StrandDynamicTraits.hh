...
public:
    ...
    void computeFutureJacobian(bool withStretch = false, bool withBend = false, bool withTwist = false, bool withViscous = true, bool butOnlyForBendingModes = false, bool dump_data = false, std::ostream& dump_stream = std::cout);
    void computeLHS( Scalar dt, bool withStretch, bool withBend = false, bool withTwist = false, bool withViscous = true, bool dump_data = false, std::ostream& dump_stream = std::cout );
    void computeFutureForces( bool withStretch = false, bool withBend = false, bool withTwist = false, bool withViscous = true, bool butOnlyForBendingModes = false, bool dump_data = false, std::ostream& dump_stream = std::cout );
